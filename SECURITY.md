...
| **Prompt injection through retrieved content** | Retrieved documents are untrusted input. The current prompt contract does **not** treat them as such, and hardening it is a known gap — see [extension point #17 in seams.md](docs/10-architecture/seams.md) |
