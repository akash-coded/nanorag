...
from fde_rag.bootstrap import bootstrap  # noqa: E402

bootstrap(verbose=False, allow_install=False)

import fde_rag  # noqa: E402
from fde_rag import metrics, pipeline  # noqa: E402
...
def main() -> int:
    ...
    bundle, _, pipe = fde_rag.quickstart(**fde_rag.TUNED, verbose=False)
